...
urlpatterns = [
    ...
    url(r'^delete_exercise/(?P<pk>[0-9]+)/$', web_views.DeleteExercise.as_view(), name='delete_exercise'),
    url(r'^delete_routine/(?P<pk>[0-9]+)/$', web_views.DeleteRoutine.as_view(), name='delete_routine'),
